                    ...
                    <div class="css-10x5fyr">
                        ...
                        <div class="css-19ce4zn">
                            <div class="css-1ipix51">
                            	<form action="xemhang.php?maloai=<?php echo isset($maloai)?$maloai:"all"?>&sapxep=1" method="post">
                                            ...
                                            <div class="css-1trsi03">
                                                <picture style="max-height:214px;max-weight=214px">
                                                    <source srcset="img/<?php echo $row["hinh"]?>" type="image/webp">
                                                        <source srcset="img/<?php echo $row["hinh"]?>" type="image/png"><img class="lazyload css-jdz5ak" alt="<?php echo $row["tensp"]?>" data-src="" src="" loading="lazy" decoding="async">
                                                </picture>
                                            </div>
                                        </div>
                                        <div class="product-card__info">
                                            <div class="css-1qgxba5"><?php echo $row["tensp"]; echo "<br>";echo $row["noidung"]?></div>
					    <div class="css-uxu180"><div class="css-m5hv1w"><div class="css-nel2x3"><span class="css-1ou7728"><?php echo currency_format($row["gia"]) ?></span></div></div><div class="css-1vhjcbm"><span color="#61c94d" size="22" class="css-wsw0i8"></span></div></div>
